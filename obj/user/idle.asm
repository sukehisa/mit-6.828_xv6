...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 20 80 00 40 	movl   $0x800f40,0x802000
  800041:	0f 80 00 
  ...
  800047:	68 45 0f 80 00       	push   $0x800f45
  80004c:	e8 f7 00 00 00       	call   800148 <cprintf>
		sys_yield();
  800051:	e8 c9 09 00 00       	call   800a1f <sys_yield>
  800056:	83 c4 10             	add    $0x10,%esp
  800059:	eb e9                	jmp    800044 <umain+0x10>
	...
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e9:	0f be 80 70 10 80 00 	movsbl 0x801070(%eax),%eax
  8001f0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002d3:	ff 24 85 00 11 80 00 	jmp    *0x801100(,%eax,4)
  ...
  80036a:	8b 3c 85 c0 10 80 00 	mov    0x8010c0(,%eax,4),%edi
  800371:	85 ff                	test   %edi,%edi
  800373:	75 19                	jne    80038e <vprintfmt+0x11a>
				printfmt(putch, putdat, "error %d", err);
  800375:	50                   	push   %eax
  800376:	68 81 10 80 00       	push   $0x801081
  ...
  80038e:	57                   	push   %edi
  80038f:	68 8a 10 80 00       	push   $0x80108a
  ...
  8003b4:	75 05                	jne    8003bb <vprintfmt+0x147>
				p = "(null)";
  8003b6:	bf 8d 10 80 00       	mov    $0x80108d,%edi
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8009e7:	68 58 12 80 00       	push   $0x801258
  8009ec:	6a 23                	push   $0x23
  8009ee:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a68:	68 58 12 80 00       	push   $0x801258
  800a6d:	6a 23                	push   $0x23
  800a6f:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aaa:	68 58 12 80 00       	push   $0x801258
  800aaf:	6a 23                	push   $0x23
  800ab1:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800aec:	68 58 12 80 00       	push   $0x801258
  800af1:	6a 23                	push   $0x23
  800af3:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b2e:	68 58 12 80 00       	push   $0x801258
  800b33:	6a 23                	push   $0x23
  800b35:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b70:	68 58 12 80 00       	push   $0x801258
  800b75:	6a 23                	push   $0x23
  800b77:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800bb2:	68 58 12 80 00       	push   $0x801258
  800bb7:	6a 23                	push   $0x23
  800bb9:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800c16:	68 58 12 80 00       	push   $0x801258
  800c1b:	6a 23                	push   $0x23
  800c1d:	68 75 12 80 00       	push   $0x801275
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c51:	50                   	push   %eax
  800c52:	68 84 12 80 00       	push   $0x801284
  ...
  800c63:	e8 8f f4 ff ff       	call   8000f7 <vcprintf>
	cprintf("\n");
  800c68:	c7 04 24 52 0f 80 00 	movl   $0x800f52,(%esp)
