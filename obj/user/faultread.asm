	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d9:	0f be 80 7a 10 80 00 	movsbl 0x80107a(%eax),%eax
  8001e0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002c3:	ff 24 85 00 11 80 00 	jmp    *0x801100(,%eax,4)
  ...
  80035a:	8b 3c 85 c0 10 80 00 	mov    0x8010c0(,%eax,4),%edi
  800361:	85 ff                	test   %edi,%edi
  800363:	75 19                	jne    80037e <vprintfmt+0x11a>
				printfmt(putch, putdat, "error %d", err);
  800365:	50                   	push   %eax
  800366:	68 8b 10 80 00       	push   $0x80108b
  ...
  80037e:	57                   	push   %edi
  80037f:	68 94 10 80 00       	push   $0x801094
  ...
  8003a4:	75 05                	jne    8003ab <vprintfmt+0x147>
				p = "(null)";
  8003a6:	bf 97 10 80 00       	mov    $0x801097,%edi
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8009d7:	68 58 12 80 00       	push   $0x801258
  8009dc:	6a 23                	push   $0x23
  8009de:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a58:	68 58 12 80 00       	push   $0x801258
  800a5d:	6a 23                	push   $0x23
  800a5f:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a9a:	68 58 12 80 00       	push   $0x801258
  800a9f:	6a 23                	push   $0x23
  800aa1:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800adc:	68 58 12 80 00       	push   $0x801258
  800ae1:	6a 23                	push   $0x23
  800ae3:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b1e:	68 58 12 80 00       	push   $0x801258
  800b23:	6a 23                	push   $0x23
  800b25:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b60:	68 58 12 80 00       	push   $0x801258
  800b65:	6a 23                	push   $0x23
  800b67:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ba2:	68 58 12 80 00       	push   $0x801258
  800ba7:	6a 23                	push   $0x23
  800ba9:	68 75 12 80 00       	push   $0x801275
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800c06:	68 58 12 80 00       	push   $0x801258
  800c0b:	6a 23                	push   $0x23
  800c0d:	68 75 12 80 00       	push   $0x801275
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c41:	50                   	push   %eax
  800c42:	68 84 12 80 00       	push   $0x801284
  ...
  800c53:	e8 8f f4 ff ff       	call   8000e7 <vcprintf>
	cprintf("\n");
  800c58:	c7 04 24 5c 0f 80 00 	movl   $0x800f5c,(%esp)
