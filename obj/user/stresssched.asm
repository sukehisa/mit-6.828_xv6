...
umain(int argc, char **argv)
{
  ...
  800039:	e8 aa 0a 00 00       	call   800ae8 <sys_getenvid>
  ...
  800040:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800045:	e8 6c 0d 00 00       	call   800db6 <fork>
  80004a:	85 c0                	test   %eax,%eax
  80004c:	74 06                	je     800054 <umain+0x20>
	int i, j;
	int seen;
	envid_t parent = sys_getenvid();
	...
	for (i = 0; i < 20; i++)
  80004e:	43                   	inc    %ebx
  80004f:	83 fb 13             	cmp    $0x13,%ebx
  800052:	7e f1                	jle    800045 <umain+0x11>
		if (fork() == 0)
			break;
	if (i == 20) {
  800054:	83 fb 14             	cmp    $0x14,%ebx
  800057:	75 0a                	jne    800063 <umain+0x2f>
		sys_yield();
  800059:	e8 a9 0a 00 00       	call   800b07 <sys_yield>
		return;
  80005e:	e9 8b 00 00 00       	jmp    8000ee <umain+0xba>
	}

	// Wait for the parent to finish forking
	while (envs[ENVX(parent)].env_status != ENV_FREE)
		asm volatile("pause");
  800063:	89 f0                	mov    %esi,%eax
  800065:	25 ff 03 00 00       	and    $0x3ff,%eax
  80006a:	89 c2                	mov    %eax,%edx
  80006c:	c1 e2 05             	shl    $0x5,%edx
  80006f:	29 c2                	sub    %eax,%edx
  800071:	8d 14 95 04 00 c0 ee 	lea    -0x113ffffc(,%edx,4),%edx
  800078:	8b 42 50             	mov    0x50(%edx),%eax
  80007b:	85 c0                	test   %eax,%eax
  80007d:	74 09                	je     800088 <umain+0x54>
  80007f:	f3 90                	pause  
  800081:	8b 42 50             	mov    0x50(%edx),%eax
  800084:	85 c0                	test   %eax,%eax
  800086:	75 f7                	jne    80007f <umain+0x4b>

	// Check that one environment doesn't run on two CPUs at once
	for (i = 0; i < 10; i++) {
  800088:	bb 00 00 00 00       	mov    $0x0,%ebx
		sys_yield();
  80008d:	e8 75 0a 00 00       	call   800b07 <sys_yield>
		for (j = 0; j < 10000; j++)
  800092:	ba 00 00 00 00       	mov    $0x0,%edx
			counter++;
  800097:	a1 04 20 80 00       	mov    0x802004,%eax
  80009c:	40                   	inc    %eax
  80009d:	a3 04 20 80 00       	mov    %eax,0x802004
	...
	for (i = 0; i < 10; i++) {
		...
		for (j = 0; j < 10000; j++)
  8000a2:	42                   	inc    %edx
  8000a3:	81 fa 0f 27 00 00    	cmp    $0x270f,%edx
  8000a9:	7e ec                	jle    800097 <umain+0x63>
	// Wait for the parent to finish forking
	while (envs[ENVX(parent)].env_status != ENV_FREE)
		asm volatile("pause");
	...
	for (i = 0; i < 10; i++) {
  8000ab:	43                   	inc    %ebx
  8000ac:	83 fb 09             	cmp    $0x9,%ebx
  8000af:	7e dc                	jle    80008d <umain+0x59>
		sys_yield();
		for (j = 0; j < 10000; j++)
			counter++;
	}
	...
	if (counter != 10*10000)
  8000b1:	a1 04 20 80 00       	mov    0x802004,%eax
  8000b6:	3d a0 86 01 00       	cmp    $0x186a0,%eax
  8000bb:	74 17                	je     8000d4 <umain+0xa0>
		panic("ran on two CPUs at once (counter is %d)", counter);
  8000bd:	a1 04 20 80 00       	mov    0x802004,%eax
  8000c2:	50                   	push   %eax
  8000c3:	68 60 11 80 00       	push   $0x801160
  8000c8:	6a 21                	push   $0x21
  8000ca:	68 88 11 80 00       	push   $0x801188
  8000cf:	e8 80 00 00 00       	call   800154 <_panic>
  ...
  8000df:	52                   	push   %edx
  8000e0:	8b 40 48             	mov    0x48(%eax),%eax
  8000e3:	50                   	push   %eax
  8000e4:	68 9b 11 80 00       	push   $0x80119b
  8000e9:	e8 42 01 00 00       	call   800230 <cprintf>
...
libmain(int argc, char **argv)
{
  ...
  80011b:	89 15 08 20 80 00    	mov    %edx,0x802008
  ...
  80012f:	53                   	push   %ebx
  800130:	56                   	push   %esi
  800131:	e8 fe fe ff ff       	call   800034 <umain>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800175:	50                   	push   %eax
  800176:	68 c4 11 80 00       	push   $0x8011c4
  ...
  800187:	e8 53 00 00 00       	call   8001df <vcprintf>
	cprintf("\n");
  80018c:	c7 04 24 b7 11 80 00 	movl   $0x8011b7,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027f:	57                   	push   %edi
  800280:	56                   	push   %esi
  800281:	e8 06 0c 00 00       	call   800e8c <__udivdi3>
  ...
  8002c7:	57                   	push   %edi
  8002c8:	56                   	push   %esi
  8002c9:	e8 ca 0c 00 00       	call   800f98 <__umoddi3>
  8002ce:	83 c4 14             	add    $0x14,%esp
  8002d1:	0f be 80 f9 12 80 00 	movsbl 0x8012f9(%eax),%eax
  8002d8:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003bb:	ff 24 85 80 13 80 00 	jmp    *0x801380(,%eax,4)
  ...
  800452:	8b 3c 85 40 13 80 00 	mov    0x801340(,%eax,4),%edi
  800459:	85 ff                	test   %edi,%edi
  80045b:	75 19                	jne    800476 <vprintfmt+0x11a>
				printfmt(putch, putdat, "error %d", err);
  80045d:	50                   	push   %eax
  80045e:	68 0a 13 80 00       	push   $0x80130a
  ...
  800476:	57                   	push   %edi
  800477:	68 13 13 80 00       	push   $0x801313
  ...
  80049c:	75 05                	jne    8004a3 <vprintfmt+0x147>
				p = "(null)";
  80049e:	bf 16 13 80 00       	mov    $0x801316,%edi
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800acf:	68 d8 14 80 00       	push   $0x8014d8
  800ad4:	6a 23                	push   $0x23
  800ad6:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b50:	68 d8 14 80 00       	push   $0x8014d8
  800b55:	6a 23                	push   $0x23
  800b57:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800b92:	68 d8 14 80 00       	push   $0x8014d8
  800b97:	6a 23                	push   $0x23
  800b99:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800bd4:	68 d8 14 80 00       	push   $0x8014d8
  800bd9:	6a 23                	push   $0x23
  800bdb:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800c16:	68 d8 14 80 00       	push   $0x8014d8
  800c1b:	6a 23                	push   $0x23
  800c1d:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800c58:	68 d8 14 80 00       	push   $0x8014d8
  800c5d:	6a 23                	push   $0x23
  800c5f:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800c9a:	68 d8 14 80 00       	push   $0x8014d8
  800c9f:	6a 23                	push   $0x23
  800ca1:	68 f5 14 80 00       	push   $0x8014f5
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800cfe:	68 d8 14 80 00       	push   $0x8014d8
  800d03:	6a 23                	push   $0x23
  800d05:	68 f5 14 80 00       	push   $0x8014f5
...
duppage(envid_t dstenv, void *addr)
{
  ...
  800d36:	50                   	push   %eax
  800d37:	68 03 15 80 00       	push   $0x801503
  800d3c:	6a 18                	push   $0x18
  800d3e:	68 16 15 80 00       	push   $0x801516
  ...
  800d62:	50                   	push   %eax
  800d63:	68 21 15 80 00       	push   $0x801521
  800d68:	6a 1a                	push   $0x1a
  800d6a:	68 16 15 80 00       	push   $0x801516
  ...
  800d9d:	50                   	push   %eax
  800d9e:	68 32 15 80 00       	push   $0x801532
  800da3:	6a 1d                	push   $0x1d
  800da5:	68 16 15 80 00       	push   $0x801516
...
sys_exofork(void)
{
  ...
  800dcc:	50                   	push   %eax
  800dcd:	68 45 15 80 00       	push   $0x801545
  800dd2:	6a 2f                	push   $0x2f
  800dd4:	68 16 15 80 00       	push   $0x801516
  ...
  800dfa:	89 15 08 20 80 00    	mov    %edx,0x802008
		return 0;
  ...
  800e0e:	81 7d f8 0c 20 80 00 	cmpl   $0x80200c,-0x8(%ebp)
  ...
  800e2d:	81 7d f8 0c 20 80 00 	cmpl   $0x80200c,-0x8(%ebp)
  ...
  800e5a:	79 12                	jns    800e6e <fork+0xb8>
		panic("sys_env_set_status: %e", r);
  800e5c:	50                   	push   %eax
  800e5d:	68 55 15 80 00       	push   $0x801555
  800e62:	6a 44                	push   $0x44
  800e64:	68 16 15 80 00       	push   $0x801516
...
sfork(void)
{
  ...
  800e7b:	68 6c 15 80 00       	push   $0x80156c
  800e80:	6a 4d                	push   $0x4d
  800e82:	68 16 15 80 00       	push   $0x801516
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800e8f:	57                   	push   %edi
  800e90:	56                   	push   %esi
  800e91:	83 ec 14             	sub    $0x14,%esp
  800e94:	8b 55 14             	mov    0x14(%ebp),%edx
  800e97:	8b 75 08             	mov    0x8(%ebp),%esi
  800e9a:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  d1 = dd.s.high;
  n0 = nn.s.low;
  800ea2:	89 75 f0             	mov    %esi,-0x10(%ebp)
  DWunion rr;
  ...
  d1 = dd.s.high;
  800ea8:	89 55 f4             	mov    %edx,-0xc(%ebp)
  n0 = nn.s.low;
  n1 = nn.s.high;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800ead:	75 11                	jne    800ec0 <__udivdi3+0x34>
    {
      if (d0 > n1)
  800eaf:	39 f8                	cmp    %edi,%eax
  800eb1:	76 4d                	jbe    800f00 <__udivdi3+0x74>
	{
	  /* 0q = nn / 0D */
  ...
  800eb8:	f7 75 e4             	divl   -0x1c(%ebp)
  800ebb:	89 c7                	mov    %eax,%edi
  800ebd:	eb 09                	jmp    800ec8 <__udivdi3+0x3c>
  800ebf:	90                   	nop
    }
    ...
    {
      if (d1 > n1)
  800ec0:	39 7d f4             	cmp    %edi,-0xc(%ebp)
  800ec3:	76 17                	jbe    800edc <__udivdi3+0x50>
	{
	  /* 00 = nn / DD */
  ...
  800ec7:	90                   	nop
		{
	      ...
	      q1 = 0;
  800ec8:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800edc:	0f bd 45 f4          	bsr    -0xc(%ebp),%eax
	  if (bm == 0)
  800ee0:	89 c7                	mov    %eax,%edi
  800ee2:	83 f7 1f             	xor    $0x1f,%edi
  800ee5:	75 4d                	jne    800f34 <__udivdi3+0xa8>
  ...
  800eea:	77 0a                	ja     800ef6 <__udivdi3+0x6a>
  ...
  800eef:	31 ff                	xor    %edi,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800ef1:	39 55 f0             	cmp    %edx,-0x10(%ebp)
  800ef4:	72 d2                	jb     800ec8 <__udivdi3+0x3c>
		{
		  q0 = 1;
  800ef6:	bf 01 00 00 00       	mov    $0x1,%edi
  800efb:	eb cb                	jmp    800ec8 <__udivdi3+0x3c>
  800efd:	8d 76 00             	lea    0x0(%esi),%esi
      ...
      else
	{
	  ...
	  if (d0 == 0)
  800f00:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  800f03:	85 c0                	test   %eax,%eax
  800f05:	75 0e                	jne    800f15 <__udivdi3+0x89>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  800f07:	b8 01 00 00 00       	mov    $0x1,%eax
  800f0c:	31 c9                	xor    %ecx,%ecx
  ...
  const DWunion ww = {{.low = q0, .high = q1}};
  800f25:	8b 55 ec             	mov    -0x14(%ebp),%edx
#ifdef L_udivdi3
UDWtype
__udivdi3 (UDWtype n, UDWtype d)
{
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f54:	89 55 f4             	mov    %edx,-0xc(%ebp)
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  800f57:	8a 4d e8             	mov    -0x18(%ebp),%cl
  800f5a:	89 f2                	mov    %esi,%edx
  800f5c:	d3 ea                	shr    %cl,%edx
	      n1 = (n1 << bm) | (n0 >> b);
  800f5e:	89 f9                	mov    %edi,%ecx
  800f60:	d3 e6                	shl    %cl,%esi
  800f62:	8b 45 f0             	mov    -0x10(%ebp),%eax
  800f65:	8a 4d e8             	mov    -0x18(%ebp),%cl
  800f68:	d3 e8                	shr    %cl,%eax
  800f6a:	09 c6                	or     %eax,%esi
	      n0 = n0 << bm;
  800f6c:	89 f9                	mov    %edi,%ecx

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800f6e:	89 f0                	mov    %esi,%eax
  800f70:	f7 75 f4             	divl   -0xc(%ebp)
  ...
  800f75:	89 c7                	mov    %eax,%edi
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800f77:	d3 65 f0             	shll   %cl,-0x10(%ebp)

	      udiv_qrnnd (q0, n1, n2, n1, d1);
	      umul_ppmm (m1, m0, q0, d0);
  800f7a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  800f7d:	f7 e7                	mul    %edi

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800f7f:	39 f2                	cmp    %esi,%edx
  800f81:	77 0f                	ja     800f92 <__udivdi3+0x106>
  800f83:	0f 85 3f ff ff ff    	jne    800ec8 <__udivdi3+0x3c>
  800f89:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  800f8c:	0f 86 36 ff ff ff    	jbe    800ec8 <__udivdi3+0x3c>
		{
		  q0--;
  800f92:	4f                   	dec    %edi
  800f93:	e9 30 ff ff ff       	jmp    800ec8 <__udivdi3+0x3c>
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800f9b:	57                   	push   %edi
  800f9c:	56                   	push   %esi
  800f9d:	83 ec 30             	sub    $0x30,%esp
  800fa0:	8b 55 14             	mov    0x14(%ebp),%edx
...
{
  800fa8:	8d 4d f0             	lea    -0x10(%ebp),%ecx
  DWunion rr;
  UWtype d0, d1, n0, n1, n2;
  UWtype q0, q1;
  UWtype b, bm;
  ...
  800fb5:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  800fc3:	89 4d ec             	mov    %ecx,-0x14(%ebp)
  UWtype q0, q1;
  UWtype b, bm;
  ...
  n1 = nn.s.high;
  800fc9:	89 55 cc             	mov    %edx,-0x34(%ebp)

#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800fcc:	75 3e                	jne    80100c <__umoddi3+0x74>
    {
      if (d0 > n1)
  800fce:	39 d6                	cmp    %edx,%esi
  800fd0:	0f 86 a2 00 00 00    	jbe    801078 <__umoddi3+0xe0>
	{
	  /* 0q = nn / 0D */

	  udiv_qrnnd (q0, n0, n1, n0, d0);
  800fd6:	f7 f6                	div    %esi
	  udiv_qrnnd (q0, n0, n1, n0, d0);
      ...
      if (rp != 0)
  800fd8:	8b 4d ec             	mov    -0x14(%ebp),%ecx
  800fdb:	85 c9                	test   %ecx,%ecx
	  ...
	  udiv_qrnnd (q1, n1, 0, n1, d0);
	  udiv_qrnnd (q0, n0, n1, n0, d0);
  800fdd:	89 55 dc             	mov    %edx,-0x24(%ebp)

	  /* Remainder in n0.  */
	}

      if (rp != 0)
  800fe0:	74 1b                	je     800ffd <__umoddi3+0x65>
	{
	  rr.s.low = n0;
  800fe2:	8b 45 dc             	mov    -0x24(%ebp),%eax
  ...
  800ff5:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  800ff8:	89 10                	mov    %edx,(%eax)
  800ffa:	89 48 04             	mov    %ecx,0x4(%eax)
  ...
  80100a:	66 90                	xchg   %ax,%ax
    ...
    {
      if (d1 > n1)
  80100c:	3b 7d cc             	cmp    -0x34(%ebp),%edi
  80100f:	76 1f                	jbe    801030 <__umoddi3+0x98>
	  q1 = 0;
  ...
  801011:	8b 55 08             	mov    0x8(%ebp),%edx
	      rr.s.high = n1;
  801014:	8b 4d cc             	mov    -0x34(%ebp),%ecx
	  q1 = 0;
	  ...
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  801017:	89 55 e0             	mov    %edx,-0x20(%ebp)
	      rr.s.high = n1;
  80101a:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
	      *rp = rr.ll;
  ...
  80102f:	c3                   	ret    
      ...
      else
	{
	  ...
	  count_leading_zeros (bm, d1);
  801030:	0f bd c7             	bsr    %edi,%eax
	  if (bm == 0)
  801033:	83 f0 1f             	xor    $0x1f,%eax
  801036:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  801039:	75 61                	jne    80109c <__umoddi3+0x104>
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  80103b:	39 7d cc             	cmp    %edi,-0x34(%ebp)
  80103e:	77 05                	ja     801045 <__umoddi3+0xad>
  801040:	39 75 dc             	cmp    %esi,-0x24(%ebp)
  801043:	72 10                	jb     801055 <__umoddi3+0xbd>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  801045:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801048:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80104b:	29 f0                	sub    %esi,%eax
  80104d:	19 fa                	sbb    %edi,%edx
  80104f:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801052:	89 55 cc             	mov    %edx,-0x34(%ebp)
	      else
		q0 = 0;
  ...
  80105a:	74 a1                	je     800ffd <__umoddi3+0x65>
		{
		  rr.s.low = n0;
  80105c:	8b 45 dc             	mov    -0x24(%ebp),%eax
		  rr.s.high = n1;
  80105f:	8b 55 cc             	mov    -0x34(%ebp),%edx
  ...
  801062:	89 45 e0             	mov    %eax,-0x20(%ebp)
		  rr.s.high = n1;
  801065:	89 55 e4             	mov    %edx,-0x1c(%ebp)
		  *rp = rr.ll;
  801068:	8b 4d ec             	mov    -0x14(%ebp),%ecx
  80106b:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80106e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801071:	89 01                	mov    %eax,(%ecx)
  801073:	89 51 04             	mov    %edx,0x4(%ecx)
  801076:	eb 85                	jmp    800ffd <__umoddi3+0x65>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  80108e:	8b 45 dc             	mov    -0x24(%ebp),%eax
	  ...
	  udiv_qrnnd (q1, n1, 0, n1, d0);
  801091:	89 55 cc             	mov    %edx,-0x34(%ebp)
	  udiv_qrnnd (q0, n0, n1, n0, d0);
  801094:	f7 f6                	div    %esi
  801096:	e9 3d ff ff ff       	jmp    800fd8 <__umoddi3+0x40>
  80109b:	90                   	nop
	  else
	    {
	      UWtype m1, m0;
  ...
  8010a1:	2b 45 d4             	sub    -0x2c(%ebp),%eax
  8010a4:	89 45 d8             	mov    %eax,-0x28(%ebp)

	      d1 = (d1 << bm) | (d0 >> b);
  8010a7:	89 fa                	mov    %edi,%edx
  8010a9:	8a 4d d4             	mov    -0x2c(%ebp),%cl
  8010ac:	d3 e2                	shl    %cl,%edx
  8010ae:	89 f0                	mov    %esi,%eax
  8010b0:	8a 4d d8             	mov    -0x28(%ebp),%cl
  8010b3:	d3 e8                	shr    %cl,%eax
	      d0 = d0 << bm;
  8010b5:	8a 4d d4             	mov    -0x2c(%ebp),%cl
  8010b8:	d3 e6                	shl    %cl,%esi
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  8010ba:	89 d7                	mov    %edx,%edi
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  8010bc:	8a 4d d8             	mov    -0x28(%ebp),%cl
  8010bf:	8b 55 cc             	mov    -0x34(%ebp),%edx
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  8010c2:	09 c7                	or     %eax,%edi
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  8010c4:	d3 ea                	shr    %cl,%edx
	      n1 = (n1 << bm) | (n0 >> b);
  8010c6:	8b 45 cc             	mov    -0x34(%ebp),%eax
  8010c9:	8a 4d d4             	mov    -0x2c(%ebp),%cl
  8010cc:	d3 e0                	shl    %cl,%eax
  8010ce:	89 45 cc             	mov    %eax,-0x34(%ebp)
  8010d1:	8a 4d d8             	mov    -0x28(%ebp),%cl
  8010d4:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8010d7:	d3 e8                	shr    %cl,%eax
  8010d9:	0b 45 cc             	or     -0x34(%ebp),%eax
  8010dc:	89 45 cc             	mov    %eax,-0x34(%ebp)
	      n0 = n0 << bm;
  8010df:	8a 4d d4             	mov    -0x2c(%ebp),%cl

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  8010e2:	f7 f7                	div    %edi
  8010e4:	89 55 cc             	mov    %edx,-0x34(%ebp)
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  8010e7:	d3 65 dc             	shll   %cl,-0x24(%ebp)

	      udiv_qrnnd (q0, n1, n2, n1, d1);
	      umul_ppmm (m1, m0, q0, d0);
  8010ea:	f7 e6                	mul    %esi

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010ec:	3b 55 cc             	cmp    -0x34(%ebp),%edx
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
	      ...
	      udiv_qrnnd (q0, n1, n2, n1, d1);
	      umul_ppmm (m1, m0, q0, d0);
  8010ef:	89 45 c8             	mov    %eax,-0x38(%ebp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  8010f2:	77 0a                	ja     8010fe <__umoddi3+0x166>
  8010f4:	75 12                	jne    801108 <__umoddi3+0x170>
  8010f6:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8010f9:	39 45 c8             	cmp    %eax,-0x38(%ebp)
  8010fc:	76 0a                	jbe    801108 <__umoddi3+0x170>
		{
		  q0--;
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  8010fe:	8b 4d c8             	mov    -0x38(%ebp),%ecx
  801101:	29 f1                	sub    %esi,%ecx
  801103:	19 fa                	sbb    %edi,%edx
  801105:	89 4d c8             	mov    %ecx,-0x38(%ebp)
		}
  ...
  80110d:	0f 84 ea fe ff ff    	je     800ffd <__umoddi3+0x65>
		{
		  sub_ddmmss (n1, n0, n1, n0, m1, m0);
  801113:	8b 4d cc             	mov    -0x34(%ebp),%ecx
  801116:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801119:	2b 45 c8             	sub    -0x38(%ebp),%eax
  80111c:	19 d1                	sbb    %edx,%ecx
  80111e:	89 4d cc             	mov    %ecx,-0x34(%ebp)
		  rr.s.low = (n1 << b) | (n0 >> bm);
  801121:	89 ca                	mov    %ecx,%edx
  801123:	8a 4d d8             	mov    -0x28(%ebp),%cl
  801126:	d3 e2                	shl    %cl,%edx
  801128:	8a 4d d4             	mov    -0x2c(%ebp),%cl
	      q1 = 0;
		...
		{
		  sub_ddmmss (n1, n0, n1, n0, m1, m0);
  80112b:	89 45 dc             	mov    %eax,-0x24(%ebp)
		  rr.s.low = (n1 << b) | (n0 >> bm);
  80112e:	d3 e8                	shr    %cl,%eax
  801130:	09 c2                	or     %eax,%edx
		  rr.s.high = n1 >> bm;
  801132:	8b 45 cc             	mov    -0x34(%ebp),%eax
  801135:	d3 e8                	shr    %cl,%eax
	      ...
	      if (rp != 0)
		{
		  sub_ddmmss (n1, n0, n1, n0, m1, m0);
		  rr.s.low = (n1 << b) | (n0 >> bm);
  801137:	89 55 e0             	mov    %edx,-0x20(%ebp)
		  rr.s.high = n1 >> bm;
  80113a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80113d:	e9 ad fe ff ff       	jmp    800fef <__umoddi3+0x57>
